  ...
  return (
    <section className=" min-h-[730px]">
      ...
      <motion.div
        ...
        className="relative top-80 lg:top-63"
      >
        <div className="container mx-auto">
          <div className="lg:mt-0 min-h-[590px] z-30 mb-8 md:mb-4 xl:mb-16">
                ...
                return (
                  <div key={index}>
                    <div className="flex flex-row lg:flex-col h-full">
                      ...
                      <div
                        div
                        className="bg-[#f0d0a8] flex-1 flex-col justify-center px-6 lg:p-12 lg:max--[250px] xl:max-h-max"
                      >
